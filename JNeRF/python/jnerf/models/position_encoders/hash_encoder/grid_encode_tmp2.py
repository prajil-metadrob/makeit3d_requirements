...
""")
        ...
        if is_grad:
            self.m_positions_list.append(self.m_positions)
        self.m_encoded_positions = self.m_encoded_positions.detach()
        if is_grad:
            self.m_encoded_positions_list.append(self.m_encoded_positions)
    ...
    def grad(self, grad_x):
        ...
        self.m_positions = self.m_positions_list.pop(0)
        self.m_encoded_positions = self.m_encoded_positions_list.pop(0)
